...
feats="$feats nnet-forward ${feature_transform:+ --feature-transform=$feature_transform} --no-softmax=false --apply-log=true --class-frame-counts=$class_frame_counts --use-gpu=$use_gpu $nnet ark:- ark:- |"
