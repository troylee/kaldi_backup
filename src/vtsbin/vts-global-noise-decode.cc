/*
 * vts-global-noise-decode.cc
 *
 *  Created on: Sept 9, 2013
 *      Author: Troy Lee (troy.lee2008@gmail.com)
 *
 * VTS decoding, with given global noise estimation.
 *
 */
...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "VTS model compensation and decoding using Diagonal GMM-based model with given global noise estimation.\n"
            "Usage:  vts-global-noise-decode [options] model-in fst-in features-rspecifier noiseparams-rspecifier"
